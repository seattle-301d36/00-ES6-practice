...
function displayPics(){
  ...
  // let allows you to declare variables that are limited in scope to the block. When it tried to console.log it couldn't find the variable because it wasn't defined locally to the entire function.
  console.log(viewed);

...
function displayPics(){
  ...
  //Because the while() construction loops through for (viewed.length), the code is trying to reassign a value to rando, which is not allowed with the const() command. This is because the const() command will set the constiable to a constant within the scope of the block, which inherintly cannot be reassigned a value.
  console.log(viewed)

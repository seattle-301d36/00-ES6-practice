...
function displayPics(){
  ...
  // The variable 'rando' was created within the above 'while' block using 'let', which confined it's scope explicitly to the 'while' loop. The console.log reference for 'rando' failed because it was made outside of the loop's scope chain, which means JS couldn't touch it without redeclaring it at that point.
  console.log(viewed);

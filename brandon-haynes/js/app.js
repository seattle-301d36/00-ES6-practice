...
function displayPics(){
  ...
  // Since 'let' has a block scope, it is not recognized outside the while loop, and therefore the console.log(rando) call does not recognize the rando variable name.
  console.log(viewed);

...
function displayPics(){
  ...
  // console.log(rando);
  // TODone: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `let to `let`.
  // The scope for 'let' is tighter than let. Since rando is defined inside of function displayPics,
  // and the console log is outside the scope of the function, it can't access the variable.
  console.log(viewed);

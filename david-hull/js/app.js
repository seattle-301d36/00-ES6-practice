...
function displayPics(){
  ...
  // I think it's because they scope to running exe context, which is contained inside of the function, whereas
    //the console code is placed after the function is closed.
  console.log(viewed)

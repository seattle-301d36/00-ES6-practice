...
function displayPics(){
  ...
  // Well it looks like the "let" is local to the the displayPics function so when console.log tries to call it outside of the block its in it is unable to find it. 
  console.log(viewed)
